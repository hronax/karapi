        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('admin.actions.new') }} {{ trans('admin.pairs.single_r') }}</div>
                    <div class="panel-body">
                        ...
                        {!! Form::open(['url' => '/admin/pairs', 'class' => 'form-horizontal', 'files' => true]) !!}

                        @include ('admin.pairs.form')
