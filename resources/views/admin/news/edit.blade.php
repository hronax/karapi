        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('admin.actions.edit') }} {{ trans('admin.news.single_r') }} #{{ $news->id }}</div>
                    <div class="panel-body">
                        ...
                        @include ('admin.news.form', ['submitButtonText' => trans('admin.actions.update')])
