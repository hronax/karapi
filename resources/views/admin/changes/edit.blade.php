        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('admin.actions.edit') }} {{ trans('admin.changes.single_r') }} #{{ $change->id }}</div>
                    <div class="panel-body">
                        ...
                        @include ('admin.changes.form', ['submitButtonText' => trans('admin.actions.update')])
