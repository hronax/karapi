        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('admin.actions.edit') }} {{ trans('admin.departments.single_r') }} #{{ $department->id }}</div>
                    <div class="panel-body">
                        ...
                        @include ('admin.departments.form', ['submitButtonText' => trans('admin.actions.update')])
