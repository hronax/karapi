        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('admin.actions.edit') }} {{ trans('admin.groups.single_r') }} #{{ $group->id }}</div>
                    <div class="panel-body">
                        ...
                        @include ('admin.groups.form', ['submitButtonText' => trans('admin.actions.update')])
