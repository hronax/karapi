        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('admin.actions.edit') }} {{ trans('admin.exams.single_r') }} #{{ $exam->id }}</div>
                    <div class="panel-body">
                        ...
                        @include ('admin.exams.form', ['submitButtonText' => trans('admin.actions.update')])
