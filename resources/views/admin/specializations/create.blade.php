        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('admin.actions.new') }} {{ trans('admin.specializations.single_r') }}</div>
                    <div class="panel-body">
                        ...
                        {!! Form::open(['url' => '/admin/specializations', 'class' => 'form-horizontal', 'files' => true]) !!}
